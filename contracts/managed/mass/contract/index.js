...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      createEscrow: async (...args_1) => {
        ...
        if (!(typeof(milestoneAmount_0) === 'bigint' && milestoneAmount_0 >= 0n && milestoneAmount_0 <= 18446744073709551615n)) {
          __compactRuntime.typeError('createEscrow',
      ...
      settleMilestone: async (...args_1) => {
        ...
        if (!(typeof(qualityRating_0) === 'bigint' && qualityRating_0 >= 0n && qualityRating_0 <= 4294967295n)) {
          __compactRuntime.typeError('settleMilestone',
                                     'argument 2 (argument 3 as invoked from Typescript)',
                                     'mass.compact line 52 char 1',
                                     'Uint<0..4294967296>',
      ...
      proveTrackRecord: async (...args_1) => {
        ...
        const contextOrig_0 = args_1[0];
        const auditorPkHash_0 = args_1[1];
        ...
        if (!(auditorPkHash_0.buffer instanceof ArrayBuffer && auditorPkHash_0.BYTES_PER_ELEMENT === 1 && auditorPkHash_0.length === 32)) {
          __compactRuntime.typeError('proveTrackRecord',
                                     'argument 1 (argument 2 as invoked from Typescript)',
                                     'mass.compact line 69 char 1',
                                     'Bytes<32>',
        ...
        if (!(typeof(qualifyingCount_0) === 'bigint' && qualifyingCount_0 >= 0n && qualifyingCount_0 <= 4294967295n)) {
          __compactRuntime.typeError('proveTrackRecord',
        ...
        if (!(typeof(minScoreFloor_0) === 'bigint' && minScoreFloor_0 >= 0n && minScoreFloor_0 <= 4294967295n)) {
          __compactRuntime.typeError('proveTrackRecord',
    ...
    this.impureCircuits = {
      ...
      settleMilestone: this.circuits.settleMilestone,
      proveTrackRecord: this.circuits.proveTrackRecord,
  ...
  async initialState(...args_0) {
    ...
    state_0.setOperation('settleMilestone', new __compactRuntime.ContractOperation());
                            ...
                            minScoreFloor_0)
  {
    ...
    __compactRuntime.assert(minScoreFloor_0 <= 100n,
                            'Quality score floor cannot exceed 100');
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { idx: { cached: false,
                                                ...
                                                path: [
                                                       { tag: 'value',
                                                         value: { value: _descriptor_8.toValue(5n),
                                                                  alignment: _descriptor_8.alignment() } }] } },
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(auditorPkHash_0),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(receiptHash_0),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } },
                                       { ins: { cached: true, n: 1 } }]);
    const tmp_0 = 1n;
